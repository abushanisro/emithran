...
export const MACHINE_CLASS_DEFAULTS: Record<MachineClass, Partial<MachineCapability>> = {
  ...
  router_2axis:   {},
  // No conservative envelope default — same reasoning. 18 real Oxyfuel
  // machines (2026-09-01) span 1-6 torches / a very wide thickness
  // capability (real cut-rate data covers 3mm-305mm) — an unclassified
  // Oxyfuel Cut machine gets EMPTY_CAPABILITY only.
  oxyfuel_cut:    {},
  ...
  // honest "no capability data, none fabricated" convention as co2_laser
  // above.
  surface_treatment: {},
};
