...
export class MHRResponseDto {
  ...
  static fromDatabase(row: any): MHRResponseDto {
    ...
    return {
      ...
      manualMHRValue: row.manual_mhr_value != null ? parseFloat(row.manual_mhr_value) : undefined,
      ...
      machinePriceUsd: row.machine_price_usd != null ? parseFloat(row.machine_price_usd) : undefined,
      manufacturerCountry: row.manufacturer_country ?? undefined,
      setupTimeHr: row.setup_time_hr != null ? parseFloat(row.setup_time_hr) : undefined,
      lhrInrPerHr: row.lhr_inr_per_hr != null ? parseFloat(row.lhr_inr_per_hr) : undefined,
      usdLaborRatePerHr: row.usd_labor_rate_per_hr != null ? parseFloat(row.usd_labor_rate_per_hr) : undefined,
      usdLhrBase: row.usd_lhr_base != null ? parseFloat(row.usd_lhr_base) : undefined,
      usdLhrBurden: row.usd_lhr_burden != null ? parseFloat(row.usd_lhr_burden) : undefined,
      ...
      mhrUsdPerHour: row.mhr_usd_per_hour != null ? parseFloat(row.mhr_usd_per_hour) : undefined,
      fullyBurdenedLocalPerHr: row.fully_burdened_local_per_hr != null ? parseFloat(row.fully_burdened_local_per_hr) : undefined,
      fullyBurdenedUsdPerHr: row.fully_burdened_usd_per_hr != null ? parseFloat(row.fully_burdened_usd_per_hr) : undefined,
      lhrUsdEffective: row.lhr_usd_effective != null ? parseFloat(row.lhr_usd_effective) : undefined,
      ...
      benchmarkDirectOverheadRateUsdHr: row.benchmark_direct_overhead_rate_usd_hr != null ? parseFloat(row.benchmark_direct_overhead_rate_usd_hr) : undefined,
      benchmarkIndirectOverheadRateUsdHr: row.benchmark_indirect_overhead_rate_usd_hr != null ? parseFloat(row.benchmark_indirect_overhead_rate_usd_hr) : undefined,
      benchmarkLaborRateUsdHr: row.benchmark_labor_rate_usd_hr != null ? parseFloat(row.benchmark_labor_rate_usd_hr) : undefined,
      ...
      maxZMm: row.max_z_mm != null ? parseFloat(row.max_z_mm) : undefined,
      maxDiameterMm: row.max_diameter_mm != null ? parseFloat(row.max_diameter_mm) : undefined,
      maxLengthMm: row.max_length_mm != null ? parseFloat(row.max_length_mm) : undefined,
      maxThicknessMm: row.max_thickness_mm != null ? parseFloat(row.max_thickness_mm) : undefined,
      maxWorkpieceWeightKg: row.max_workpiece_weight_kg != null ? parseFloat(row.max_workpiece_weight_kg) : undefined,
      maxThicknessMsMm: row.max_thickness_ms_mm != null ? parseFloat(row.max_thickness_ms_mm) : undefined,
      maxThicknessSsMm: row.max_thickness_ss_mm != null ? parseFloat(row.max_thickness_ss_mm) : undefined,
      maxThicknessAlMm: row.max_thickness_al_mm != null ? parseFloat(row.max_thickness_al_mm) : undefined,
      maxThicknessCuMm: row.max_thickness_cu_mm != null ? parseFloat(row.max_thickness_cu_mm) : undefined,
      ...
      laborTimeStandard: row.labor_time_standard != null ? parseFloat(row.labor_time_standard) : undefined,
      avgUtilization: row.avg_utilization != null ? parseFloat(row.avg_utilization) : undefined,
      goodPartYield: row.good_part_yield != null ? parseFloat(row.good_part_yield) : undefined,
      machineLengthMm: row.machine_length_mm != null ? parseFloat(row.machine_length_mm) : undefined,
      machineWidthMm: row.machine_width_mm != null ? parseFloat(row.machine_width_mm) : undefined,
      machineLifeYr: row.machine_life_yr != null ? parseFloat(row.machine_life_yr) : undefined,
      machinePowerKw: row.machine_power_kw != null ? parseFloat(row.machine_power_kw) : undefined,
      machineUptimePct: row.machine_uptime_pct != null ? parseFloat(row.machine_uptime_pct) : undefined,
      annualMaintenanceFactorPct: row.annual_maintenance_factor_pct != null ? parseFloat(row.annual_maintenance_factor_pct) : undefined,
      footprintAllowanceFactor: row.footprint_allowance_factor != null ? parseFloat(row.footprint_allowance_factor) : undefined,
      installationFactorPct: row.installation_factor_pct != null ? parseFloat(row.installation_factor_pct) : undefined,
